        ...
        <div className="flex items-center gap-6">
          ...
          <div className="hidden sm:flex items-center">
            <div className="flex items-center gap-2 sm:gap-4 ml-6">
              ...
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 !transition-colors flex items-center justify-center p-1">
              ...
              <div className="h-10 w-[1px] bg-white/20"></div>
              <a href={socialUrl('facebook')} target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 !transition-colors flex items-center justify-center p-1">
              ...
              <div className="h-10 w-[1px] bg-white/20"></div>
              <a href={socialUrl('linkedin')} target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 !transition-colors flex items-center justify-center p-1">
