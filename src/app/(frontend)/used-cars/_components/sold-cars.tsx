                        ...
                        <div className="flex flex-col flex-1 px-3 pt-2.5 pb-0">
                          ...
                          <div className="mt-3 grid grid-cols-3 border-t border-l border-white/10">
                            <a
                              ...
                              onClick={(e) => { e.stopPropagation(); if (isSold) e.preventDefault() }}
                              aria-disabled={isSold}
                              className={`flex items-center justify-center gap-1 py-2 border-r border-b border-white/10 text-[10px] font-bold tracking-wide text-white !transition-colors ${isSold ? 'opacity-30 cursor-not-allowed pointer-events-none' : 'hover:bg-white/5'}`}
                            >
                            ...
                            <button
                              ...
                              className="flex items-center justify-center py-2 border-r border-b border-white/10 text-[10px] font-bold tracking-wide text-white !transition-colors disabled:opacity-30 disabled:cursor-not-allowed hover:bg-white/5 disabled:hover:bg-transparent"
                            >
                              Reserve
                            </button>
                            <Link
                              href={isSold ? '#' : financeUrl}
                              onClick={(e) => { e.stopPropagation(); if (isSold) e.preventDefault() }}
                              aria-disabled={isSold}
                              className={`flex items-center justify-center gap-1 py-2 border-b border-white/10 text-[10px] font-bold tracking-wide text-white !transition-colors ${isSold ? 'opacity-30 cursor-not-allowed pointer-events-none' : 'hover:bg-white/5'}`}
                            >
